...
class Page(models.Model):
    ...
    space = models.ForeignKey('crm.Space', null=True, blank=True, related_name='pages', on_delete=models.SET_NULL)
    ...
    organization = models.ForeignKey('core.Organization', on_delete=models.CASCADE, related_name='pages')
